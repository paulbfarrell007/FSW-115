...
document.querySelector("#flexContainer").addEventListener("submit", function(e){
    e.preventDefault();
    axios.post("http://api.bryanuniversity.edu/paulfarrell/list/", {
    ...
    checkBox.forEach(function(e, i){
        e.addEventListener("change", function(){
            if (e.checked === true){
                ...
                axios.put(`http://api.bryanuniversity.edu/paulfarrell/list/${myId[i]}`, {
                    isComplete: true
                })
                    .catch(err => console.log(err))
            }
...
document.addEventListener("mouseover", function(){
    ...
    myDelete.forEach(function(e, i){
        e.addEventListener("click", function(){
            axios.delete(`http://api.bryanuniversity.edu/paulfarrell/list/${myId[i]}`)
                .catch(err => console.log(err))
